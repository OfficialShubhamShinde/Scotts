...
<head>
    ...
    <title>Services | Lawn Mowers</title>
...
<body>
    <div class="banner-section" style="background-color: rgb(14,22,41); color: white;">
        <div class="container">
            <header
                ...
                <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="../index.php" class="nav-link px-2 link-secondary text-white">Home</a></li>
                    <li><a href="#" class="nav-link px-2 link-secondary text-white">About</a></li>
                    <div class="dropdown">
                        <a href="#" class="nav-link px-2" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="flex items-center">
                                <span class="link-secondary text-white"><b>Services</b></span>
                    ...
                    <li></li>
                    <li><a href="#" class="nav-link px-2 link-secondary text-white">Contact</a></li>
                </ul>
        ...
        <div class="px-4  my-5 text-center">
            <h1 class="display-5 fw-bold text-white">Lawn Mowers</h1>
            <div class="col-lg-6 mx-auto">
                <p class="lead mb-4 mt-3">Elevate your lawn's beauty with our top-notch Lawn Mower services for a
                    greener, healthier, and perfectly manicured yard.</p> <br> <br>
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    ...
                    <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div
                            class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-dialog modal-fullscreen">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <section
                                        class="text-gray-600 body-font relative flex justify-center items-center h-screen">
                                        ...
                                        <form action="selectService.php" method="POST">
                                            <div
                                                ...
                                                <div class="relative  flex items-center">
                                                    <p class="mr-3 mt-3"><svg xmlns="http://www.w3.org/2000/svg"
                                                            width="25" fill="currentColor" class="bi bi-crosshair"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                    ...
                                                    <!-- <select class="form-select" aria-label="Default select example">
                                                        <option selected>Open your location</option>
        ...
        <div class="container">
            <footer class="py-5">
                <div class="row">
                    <div class="col-6 col-md-2 mb-3">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">About us</a>
                            </li>
                    ...
                    <div class="col-6 col-md-2 mb-3">
                        <h5>Services</h5>
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Lawn Mowers</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Pressure Washers</a>
                            </li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Edgers</a>
                            </li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Backpack Blowers</a>
                            </li>
                            </li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Rotto Tillers</a></li>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-6 col-md-2 mb-3">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Terms & Conditions
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                    <p>© 2023 <a href="https://asdrinfotech.com/" style="text-decoration: none; color: white;">ASDR
                            Infotech</a>, All rights reserved.</p>
                    <ul class="list-unstyled d-flex">
                        <li class="ms-3"><a class="link-body-emphasis" href="#"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="white" class="bi bi-twitter" viewBox="0 0 16 16">
                                    <path
                                        d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
                                </svg></a></li>
                        <li class="ms-3"><a class="link-body-emphasis" href="#"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="white" class="bi bi-linkedin" viewBox="0 0 16 16">
                                    <path
                                        d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z" />
                                </svg></a></li>
                        <li class="ms-3"><a class="link-body-emphasis" href="#"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="white" class="bi bi-instagram" viewBox="0 0 16 16">
                                    <path
